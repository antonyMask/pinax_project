...
@section('content')
<div class="card">
    <!-- Header con estilos inline forzados -->
    <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; background: #f4f6f9; padding: 0.75rem 1.25rem;">
        <h3 class="card-title" style="margin: 0; font-size: 1.1rem; font-weight: 500; float: none;">Lista de Reportes Financieros</h3>
        <div style="margin: 0; float: none;">
            <a href="{{ route('reportes.create') }}" class="btn btn-primary btn-sm" style="white-space: nowrap;">
...
<style>
    ...
    /* Resetear estilos de AdminLTE en el card-header */
    .card-header {
